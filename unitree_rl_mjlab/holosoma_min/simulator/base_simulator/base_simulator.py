...
from holosoma_min.config_types.experiment import TrainingConfig
from holosoma_min.config_types.full_sim import FullSimConfig
from holosoma_min.config_types.robot import RobotConfig
from holosoma_min.config_types.simulator import SimulatorInitConfig
from holosoma_min.managers.terrain import TerrainManager
from holosoma_min.simulator.shared.object_registry import ObjectRegistry
from holosoma_min.simulator.shared.scene_types import SceneInterface
from holosoma_min.simulator.types import ActorIndices, ActorNames, ActorStates, EnvIds
from holosoma_min.utils.experiment_paths import get_video_dir
from holosoma_min.utils.safe_torch_import import torch
from holosoma_min.utils.simulator_config import SimulatorType, get_simulator_type

if TYPE_CHECKING:
    from holosoma_min.simulator.shared.camera_controller import CameraController
    from holosoma_min.simulator.shared.simulator_bridge import SimulatorBridge
    from holosoma_min.simulator.shared.video_recorder import VideoRecorderInterface
    from holosoma_min.simulator.shared.virtual_gantry import VirtualGantry
    ...
    **Batched Updates (Performance)**:
    ...
    def set_dof_state_tensor_robots(
        ...
        **IMPORTANT**: Tensor shapes differ between simulators. See simulator-specific
        ...
        - IsaacSim: `holosoma_min.simulator.isaacsim.IsaacSim.set_dof_state_tensor_robots`
        - IsaacGym: `holosoma_min.simulator.isaacgym.IsaacGym.set_dof_state_tensor_robots`
