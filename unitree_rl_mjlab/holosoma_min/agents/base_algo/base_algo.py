...
from holosoma_min.config_types.algo import AlgoInitConfig
from holosoma_min.envs.base_task.base_task import BaseTask
from holosoma_min.utils.safe_torch_import import torch

if TYPE_CHECKING:
    from holosoma_min.config_types.experiment import ExperimentConfig
...
class BaseAlgo:
    ...
    def _distributed_barrier(self) -> None:
        """NCCL-safe barrier; all ranks must call collectively."""
