from holosoma_min.config_types.terrain import MeshType, TerrainManagerCfg, TerrainTermCfg

terrain_locomotion_plane = TerrainManagerCfg(
    terrain_term=TerrainTermCfg(
        func="holosoma_min.managers.terrain.terms.locomotion:TerrainLocomotion",
