...
from holosoma_min.config_types.randomization import RandomizationManagerCfg, RandomizationTermCfg

robot_state_dr_at_setup = {
    "randomize_robot_rigid_body_material_startup": RandomizationTermCfg(
        func="holosoma_min.managers.randomization.terms.locomotion:randomize_robot_rigid_body_material_startup",
        params={
    ...
    "randomize_base_com_startup": RandomizationTermCfg(
        func="holosoma_min.managers.randomization.terms.locomotion:randomize_base_com_startup",
        params={
    ...
    "setup_dof_pos_bias": RandomizationTermCfg(
        func="holosoma_min.managers.randomization.terms.locomotion:setup_dof_pos_bias",
        params={
...
object_state_dr_at_setup = {
    "randomize_object_rigid_body_material_startup": RandomizationTermCfg(
        func="holosoma_min.managers.randomization.terms.locomotion:randomize_object_rigid_body_material_startup",
        params={
    ...
    "randomize_object_rigid_body_mass_startup": RandomizationTermCfg(
        func="holosoma_min.managers.randomization.terms.locomotion:randomize_object_rigid_body_mass_startup",
        params={
            "mass_distribution_params": [1.0, 4.0],
        },
    ),
    "randomize_object_rigid_body_inertia_startup": RandomizationTermCfg(
        func="holosoma_min.managers.randomization.terms.locomotion:randomize_object_rigid_body_inertia_startup",
        params={
...
base_setup_terms = {
    "push_randomizer_state": RandomizationTermCfg(
        func="holosoma_min.managers.randomization.terms.locomotion:PushRandomizerState",
        params={
    ...
    "actuator_randomizer_state": RandomizationTermCfg(
        func="holosoma_min.managers.randomization.terms.locomotion:ActuatorRandomizerState",
        params={
            "kp_range": [0.9, 1.1],
            "kd_range": [0.9, 1.1],
    ...
    "setup_action_delay_buffers": RandomizationTermCfg(
        func="holosoma_min.managers.randomization.terms.locomotion:setup_action_delay_buffers",
        params={
...
base_reset_terms = {
    ...
    "randomize_push_schedule": RandomizationTermCfg(
        func="holosoma_min.managers.randomization.terms.locomotion:randomize_push_schedule",
    ),
    "randomize_action_delay": RandomizationTermCfg(
        func="holosoma_min.managers.randomization.terms.locomotion:randomize_action_delay",
    ),
    "actuator_randomizer_state": RandomizationTermCfg(
        func="holosoma_min.managers.randomization.terms.locomotion:ActuatorRandomizerState"
    ),
    "randomize_dof_state": RandomizationTermCfg(
        func="holosoma_min.managers.randomization.terms.locomotion:randomize_dof_state",
        params={
...
base_step_terms = {
    ...
    "apply_pushes": RandomizationTermCfg(
        func="holosoma_min.managers.randomization.terms.locomotion:apply_pushes",
    ),
}
