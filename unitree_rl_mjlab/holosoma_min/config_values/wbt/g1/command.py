...
from holosoma_min.config_types.command import CommandManagerCfg, CommandTermCfg, MotionConfig, NoiseToInitialPoseConfig
...
g1_29dof_wbt_command = CommandManagerCfg(
    ...
    setup_terms={
        "motion_command": CommandTermCfg(
            func="holosoma_min.managers.command.terms.wbt:MotionCommand",
            params={
