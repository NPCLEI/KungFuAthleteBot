...
import holosoma_min.config_types.simulator
...
class SimulatorConfig:
    ...
    @classmethod
    def set_simulator_type(cls, config: holosoma_min.config_types.simulator.SimulatorConfig) -> None:
...
def set_simulator_type(config: holosoma_min.config_types.simulator.SimulatorConfig) -> None:
